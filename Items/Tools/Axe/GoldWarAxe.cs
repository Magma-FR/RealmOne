...
{
    public class GoldWarAxe : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Gold War Axe"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
