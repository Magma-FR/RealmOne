...
{
    public class PlatinumCoinFriendly : ModProjectile
    {
        ...
        {
            return new Color(229, 229, 229, 0) * Projectile.Opacity;
        }
        ...
        {
            int num553 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Platinum);
