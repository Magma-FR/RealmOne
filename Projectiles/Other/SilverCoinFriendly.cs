...
{
    public class SilverCoinFriendly : ModProjectile
    {
        ...
        {
            return new Color(197, 197, 197, 0) * Projectile.Opacity;
        }
        ...
        {
            int num553 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Silver);
